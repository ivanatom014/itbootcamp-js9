...
.catch((e) => {
    divError.innerHTML = `An arror occured: ${e}`;
...
//// Umesto direktnog pristupa dokumentima neke kolekcije, //mnogo je boljee pristupati snapshotovima, odnosno 
 // osluskivati promene kolekcije
